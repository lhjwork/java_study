...
interface MoveAble{
	// public abstract 생략외어 있음 안적으면
	//원래 형태 : public abstract void 위();
	void 위();
	void 아래();
	void 왼쪽();
	void 오른쪽();
...
class 원숭이 extends 온순한동물{
	...
	@Override // 어노테이션 = JVM이 실행시에 분석해서 확인 = JVM의 흰트
	void 채집() {
